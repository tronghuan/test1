...
package crefil_eventlog.crefil_loginlog_1_0;
...
/**
 * Job: CREFIL_LoginLog Purpose: ログイン履歴ログを出力<br>
 * Description: Salesforceからログイン履歴ログを取得し、CSVファイルに保存する。 <br>
 * 
 * @author huan.dao@furucrm.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class CREFIL_LoginLog implements TalendJob {
	...
	private final String jobName = "CREFIL_LoginLog";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CREFIL_LoginLog.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CREFIL_LoginLog.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_CREFIL_EVENTLOG_CREFIL_LoginLog = new byte[0];
		static byte[] commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog.length) {
					if (length < 1024 && commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog.length == 0) {
						commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog = new byte[1024];
					} else {
						commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog, 0, length);
				strReturn = new String(commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog, 0, length);
				strReturn = new String(commonByteArray_CREFIL_EVENTLOG_CREFIL_LoginLog, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CREFIL_EVENTLOG_CREFIL_LoginLog) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/dthbk/Desktop/Talend_Workspace/login_event_log.csv")).getAbsolutePath().replace("\\",
								"/");
				...
				props_tSalesforceInput_1.connection.userPassword.setValue("securityKey",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:Ce7rW2u4Cc9CO9ObQFmHGcuTdjmatCpEaa6F4aI8YbFwXXl2puD3HMzpYSB2JlIj0wZlyg=="));
				...
				props_tSalesforceInput_1.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:lcEib4dafc4Tdq/yKBrRvscXN0fB/YngQVWyQpCoorabbGUcDACm"));
				...
				props_tSalesforceInput_1.module.connection.userPassword.setValue("securityKey",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:86Tju0Be6x9PFOrSOFO/+5JVnLqLJxRm0ztRHObBY+CqGdFKXev6UBuB7vTgBf4lv1I4mw=="));
				...
				props_tSalesforceInput_1.module.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:zbryRr6sBjWC4g9cQHp8PkzADl1EO0vYv7P2H015ZzizK1GSNPbH"));
...
// finally of generic
	...
	public static void main(String[] args) {
		final CREFIL_LoginLog CREFIL_LoginLogClass = new CREFIL_LoginLog();

		int exitCode = CREFIL_LoginLogClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CREFIL_LoginLog.class.getClassLoader()
					.getResourceAsStream("crefil_eventlog/crefil_loginlog_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CREFIL_LoginLog.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : CREFIL_LoginLog");
		}
...
/************************************************************************************************
 * 91895 characters generated by Talend Open Studio for Data Integration on the
 * August 26, 2022 at 3:03:37 PM ICT
 ************************************************************************************************/